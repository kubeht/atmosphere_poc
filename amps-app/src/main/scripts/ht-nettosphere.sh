...
unset HT_NETTOSPHERE_OPTS

export HT_NETTOSPHERE_OPTS="-Dlogback.configurationFile=conf/logback.xml "
...
echo "Starting HT_NETTOSPHERE:"
PARAMETERS="-classpath lib/*: com.me.amps.bootstrap.MessageServiceBootstraper"
COMMAND="java -server ${HT_NETTOSPHERE_OPTS} ${JAVA_OPTS} ${DEV_OPTS} ${PARAMETERS}"
echo $COMMAND
$COMMAND
