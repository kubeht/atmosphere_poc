...
public class LongPollingAuthenticationTest extends AbstractTestNGSpringContextTests {

	private final static Logger logger = LoggerFactory
			.getLogger(LongPollingAuthenticationTest.class);
	...
	private final static Request.TRANSPORT TRANSPORT = Request.TRANSPORT.LONG_POLLING;
	...
	public LongPollingAuthenticationTest() {
	...
	@Test
	public void testLongPollingAuthenticateSuccess() throws Exception {
		Long userId = 456L;
		requestBuilder
				.header(
	...
	@Test
	public void testLongPollinContextError() throws Exception {
		Long userId = 456L;
		requestBuilder
				.header(
				MessageSubscribeServiceConstants.HT_SVC_REQUEST_CONTEXT,
	...
	@Test
	public void testLongPollinAuthenticateFailure() throws Exception {
		Long userId = 456L;
		requestBuilder
				.header(
				MessageSubscribeServiceConstants.HT_SVC_REQUEST_CONTEXT,
