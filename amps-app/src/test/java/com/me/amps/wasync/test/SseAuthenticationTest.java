...
public class SseAuthenticationTest extends AbstractTestNGSpringContextTests {

	private final static Logger logger = LoggerFactory
			.getLogger(SseAuthenticationTest.class);
	...
	private final static Request.TRANSPORT TRANSPORT = Request.TRANSPORT.SSE;
	...
	@Test
	public void testSseAuthenticateSuccess() throws Exception {
		Long userId = 345L;
		requestBuilder
				.header(
		...
		// socket should be opened by this time
		Assert.assertEquals(socket.status(), STATUS.OPEN);
	...
	@Test
	public void testSseAuthenticateContextError() throws Exception {
		Long userId = 345L;
		requestBuilder
				.header(
				MessageSubscribeServiceConstants.HT_SVC_REQUEST_CONTEXT,
	...
	@Test
	public void testSseAuthenticateFailure() throws Exception {
		Long userId = 345L;
		requestBuilder
				.header(
				MessageSubscribeServiceConstants.HT_SVC_REQUEST_CONTEXT,
